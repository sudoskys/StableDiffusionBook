...
可以使用 艺术家，工作室，摄影术语，角色名字，风格，特效等等。这些内容可以在 上面提到的法术书(示例集) 或者 [人偶教室的测试记录](https://www.yuque.com/longyuye/lmgcwy) 查看，这些项目在关于中可以看到。
...
训练时一般设置为 0.005，如果想快一些，可以使用 0.01 加快。但是如果设置得太高，可能会破坏 `embedding` ， loss 达不到预期。
